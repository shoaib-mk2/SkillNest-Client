...
const Footer = () => {
    return (
        <div className="bg-neutral text-neutral-content">
            ...
            <footer className="md:w-4/5 mx-auto footer px-10 py-4 border-t border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>SKillNest <br />Providing reliable jobs since 1995 <br />Copyright © 2023 - All right reserved by SkillNest</p>
                </aside>
